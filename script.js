...
let srchBtn = document.getElementById("btns");

srchBtn.onclick = ()=>{
    let inp = document.getElementById("srch");
    let pDiv = document.getElementById("table");
    ...
    <tr>
        ...
        <td class="std">Class</td>
        <td class="marks">Marks</td>
        <td class="passing">Passing</td>
    ...
    arr.forEach((obj)=>{
        if(obj.first_name.toUpperCase()==inp.value.toUpperCase() || obj.last_name.toUpperCase()==inp.value.toUpperCase()||obj.email.toUpperCase()==inp.value.toUpperCase()){
            pDiv.innerHTML+=`
            <tr>
                <td class="id">${obj.id}</td>
                <td class="name">
                <img src="${obj.img_src}">
                ${obj.first_name} ${obj.last_name}</td>
                <td class="gender">${obj.gender}</td>
                <td class="std">${obj.class}</td>
                <td class="marks">${obj.marks}</td>
                <td class="passing">${obj.passing?"Passed":"Failed"}</td>
...
let btn1 = document.getElementById("satz");
...
let btn2 = document.getElementById("szta");
...
let btn3 = document.getElementById("sbm");
btn3.onclick = ()=>{
    arr.sort((a,b)=>{
...
let btn4 = document.getElementById("sbp");

btn4.onclick = ()=>{
    arr.sort(comparePass);

    display(arr);
    

    function comparePass(a,b){
        const name1 = a.passing.toString().toUpperCase();
        const name2 = b.passing.toString().toUpperCase();
...
let btn5 = document.getElementById("sbc");
btn5.onclick = ()=>{
    arr.sort((a,b)=>{
...
let btn6 = document.getElementById("sbg");

btn6.onclick = ()=>{
    arr.sort(compareGender);
    ...
    function compareGender(a, b) {
        ...
        // converting to uppercase to have case-insensitive comparison
            const name1 = a.gender.toUpperCase();
            const name2 = b.gender.toUpperCase();
